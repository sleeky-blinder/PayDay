...
el('btnSaveOpen').addEventListener('click',function(){ ACC.forEach(function(a){ var v=el('open-'+a.id); if(v) state.opening[a.id]=nv(v.value)||0; }); saveState(); render(); toast('Openings saved'); });
